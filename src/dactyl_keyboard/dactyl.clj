...
(def wall-z-offset -1)                 ; original=-15 length of the first downward-sloping part of the wall (negative)
...
(def left-wall-x-offset 1) ; original 10
(def left-wall-z-offset 1) ; original 3
...
(def case-walls
  (union
   ...
   ; front wall
   (for [x (range 2 ncols)] (key-wall-brace x cornerrow 0 -1 web-post-bl x       cornerrow 0 -1 web-post-br))
   ...
   (wall-brace thumb-tr-place  0 -1 thumb-post-br (partial key-place 2 cornerrow)  0 -1 web-post-bl)
